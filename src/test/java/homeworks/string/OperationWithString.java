...
//        System.out.println ("getSentence method 1 " + m.getSentence ());
        ...
        model.setBigLT(toUpperCase(model.getSentence()));
    ...
    private static int textLength(String userInput) {
    ...
    private static long countLetters(String userInput) {
    ...
    private static String changeSymbolFromOldToNew(String userInput) {
        char oldSymbol;
        char newSymbol;
    ...
    private static char[] sentenceToArray(String userInput) {
    ...
    private static String partOfSentence(String userInput) {
        char firstSymbol;
        char lastSymbol;
    ...
    private static void indexOfSymbols(String userInput) {
    ...
    private static String viceVersa(String userInput) {
...
//        }
    ...
    private static String toLoverCase(String userInput) {
